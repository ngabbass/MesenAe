...
export interface StoreSettings { id?: string | number; storeName: string; address: string; phone: string; receiptFooter: string; onboardingDone: boolean; themeColor?: string; logo?: string; tables?: string[]; promoBanners?: any[]; deliveryMode?: 'ambil' | 'diantar'; enableWhatsappNotification?: boolean; enableKitchen?: boolean; }
